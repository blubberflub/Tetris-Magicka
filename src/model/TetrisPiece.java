...
public enum TetrisPiece
{
    ...
    L(3,
                    2, // Color.ORANGE,
                    new Color(233, 164, 0), new Point(2, 2), new Point(0, 1), new Point(1, 1),
                    new Point(2, 1)),
     ...
     */
    T(3,
                    2, // Color.MAGENTA.darker().darker(),
                    new Color(185, 33, 255), new Point(1, 2), new Point(0, 1),
    ...
    /**
     * Whether or not piece is hold or not.
     */
    private boolean myHold;
    ...
    //NEW METHOD
    /**
     * Sets the piece as a hold piece.
     * @param theBoolean whether or not it is a hold piece.
     */
    public void setAsHoldPiece(Boolean theBoolean)
    {
        myHold = theBoolean;       
    }
    
    public boolean isHoldPiece()
    {
        return myHold;
    }

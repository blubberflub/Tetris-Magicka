...
public class Board extends Observable
{
    ...
    // NEW FIELDS
    /**
     * Piece that is being held.
     */
    private TetrisPiece myHeldPiece;

    /**
     * Temporary hold storage.
     */
    private TetrisPiece myHoldStore;
    
    /**
     * If held already pressed.
     */
    private boolean myCurrentlyHolding;
    ...
    public void hold()
    {
        if (myHeldPiece == null && myCurrentlyHolding == false)
        {
            myHeldPiece = myCurrentPiece.getTetrisPiece();
            myCurrentPiece = getNextMovablePiece(false);
            myCurrentlyHolding = true;
        }
        else if (myCurrentlyHolding == false)
        {
            myHoldStore = myCurrentPiece.getTetrisPiece();
            myCurrentPiece = getHoldPiece();
            myHeldPiece = myHoldStore;
            myCurrentlyHolding = true;
        }

        myHeldPiece.setAsHoldPiece(true);
        setChanged();
        notifyObservers(myHeldPiece);
    ...
    /**
     * Starts the hold piece at the top.
     */
    public MovableTetrisPiece getHoldPiece()
    {
        MovableTetrisPiece piece;

        int startY = myHeight - 1;
        if (myHeldPiece == TetrisPiece.I)
        {
            startY--;
        }
        piece =
                        new MovableTetrisPiece(
                                               myHeldPiece,
                                               new Point(
                                                         (myWidth - myNextPiece.getWidth()) / 2,
                                                         startY));
    ...
    public void rotateCW()
    {
        if (myCurrentPiece != null)
        {
            ...
            else
            {
                ...
                final Point[] offsets =
                                WallKick.getWallKicks(cwPiece.getTetrisPiece(),
    ...
    public void rotateCCW()
    {
        if (myCurrentPiece != null)
        {
            ...
            else
            {
                ...
                final Point[] offsets =
                                WallKick.getWallKicks(ccwPiece.getTetrisPiece(),
                                                      myCurrentPiece.getRotation(),
    ...
    private MovableTetrisPiece getNextMovablePiece(final boolean theRestart)
    {
        ...
        prepareNextMovablePiece();
        //Hold is available again.
        myCurrentlyHolding = false;
        return piece;
    }
    ...
    private void prepareNextMovablePiece()
    {
        ...
        if (myNonRandomPieces == null || myNonRandomPieces.isEmpty())
        {
            ...
            //Make sure my next piece isn't mistaken for a hold piece.
            myNextPiece.setAsHoldPiece(false);
        }
        else
        {
    ...
    /**
     * A class to describe the lines that have been cleared to registered
     * Observers.
     */
    public final class CompletedLines
    {
         ...
         * 
         * @param theClearedLines a list containing the indexes of lines which
         *            were cleared
         */
    ...
    public final class GameStatus
    {
        ...
        //CHANGED METHOD TO PUBLIC 
        //TO IMPLEMENT END GAME ON ACTION.
        /**
         * Set the game over status of the board.
         * 
         * @param theGameOverFlag the game over status to set
         */
        public void setGameOver(final boolean theGameOverFlag)
        {
